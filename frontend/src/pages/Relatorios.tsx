            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <option value="quantity">
                  Por quantidade de alunos matriculados
                </option>
          ...
          {!isReportGenerated ? (
            ...
            <div className="flex-1 border-2 border-dashed border-[#322A6A] rounded-xl flex items-center justify-center bg-[#f8f8f8] print:hidden">
              <p className="hidden lg:block text-[#322A6A] text-lg font-medium text-center px-4">
                Selecione o semestre e a ordenação acima para gerar e visualizar
                o relatório.
              </p>
              <p className="lg:hidden text-[#322A6A] text-lg font-medium text-center px-4">
                Ainda será possível baixar o relatório em PDF. No entanto, para
                pre-visualizar o relatório, acesse o sistema de um dispositivo
            ...
            <div className="flex-col h-full gap-4 relative">
              ...
              >
                ...
                {/* A4 Paper Frame */}
                <div className="bg-white w-[210mm] min-h-[297mm] shadow-lg p-[20mm] flex flex-col print:shadow-none print:w-full print:min-h-0 print:p-0">
                  {/* Report Header */}
                  ...
                  <table className="w-full border-collapse text-black text-sm text-left">
                    <thead>
                      <tr>
                        <th className="border border-black p-3 font-bold bg-gray-50 w-12 text-center">
                          #
                        </th>
                        <th className="border border-black p-3 font-bold bg-gray-50">
                          Nome da Disciplina
                        </th>
                        <th className="border border-black p-3 font-bold bg-gray-50">
                          Departamento
                        </th>
                        <th className="border border-black p-3 font-bold bg-gray-50 text-center">
                          Alunos Matriculados
                        </th>
                      </tr>
                    </thead>
